...
class HttpHelper{
  ...
  final String urlKey = 'api_key=f80383736a6ef38a470fa57fbfda4d11';
  final String urlBase = 'https://api.themoviedb.org/3/movie';
  final String urlUpcoming = '/upcoming?';
  final String urlLanguage = '&language=en-US';
  final String urlSearchBase = 'https://api.themoviedb.org/3/search/movie?'
      'api_key=f80383736a6ef38a470fa57fbfda4d11&query=';
  final String urlTopRated = 'https://api.themoviedb.org/3/movie/top_rated?api_key=f80383736a6ef38a470fa57fbfda4d11&language=en-US';
